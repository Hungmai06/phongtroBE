...
public interface EmailService {
    void handleContractEmail(ContractMailEvent event) throws MessagingException;
    ...
    void sendContractInfoWithAttachment(ContractEmailRequest request) throws MessagingException;
